 ...
 * Use the [HousesPageFragment3.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page3, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage3()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment3.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment3().apply {
