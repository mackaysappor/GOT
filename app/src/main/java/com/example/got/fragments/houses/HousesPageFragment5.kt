 ...
 * Use the [HousesPageFragment5.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment5 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page5, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage5()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment5.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment5().apply {
