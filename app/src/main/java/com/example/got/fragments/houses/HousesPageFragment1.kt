 ...
 * Use the [HousesPageFragment1.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment1 : Fragment() {

    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private lateinit var houseRecyclerView1: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getHouseData { houses ->
            ...
            houseRecyclerView1.adapter = houseAdapter
            houseRecyclerView1.layoutManager = GridLayoutManager(context, 2)
        }
        common = Common()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        houseRecyclerView1 = view.findViewById(R.id.housesRecyclerView1)
        houseRecyclerView1.setHasFixedSize(true)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage1()
