 ...
 * Use the [HousesPageFragment8.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment8 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page8, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage8()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment8.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment8().apply {
