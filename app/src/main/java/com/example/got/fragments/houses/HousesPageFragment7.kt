 ...
 * Use the [HousesPageFragment7.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment7 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page7, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage7()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment7.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment7().apply {
