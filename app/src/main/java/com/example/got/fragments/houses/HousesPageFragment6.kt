 ...
 * Use the [HousesPageFragment6.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page6, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage6()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment6.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment6().apply {
