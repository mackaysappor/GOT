 ...
 * Use the [HousesPageFragment4.newInstance] factory method to
 * create an instance of this fragment.
 */
class HousesPageFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_houses_page4, container, false)
    }
    ...
    private fun getHouseData(callback: (List<House>) -> Unit) {
        ...
        val retrofitData = retrofitBuilder.getHousesPage4()
    ...
    companion object {
         ...
         * @return A new instance of fragment HousesPageFragment4.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HousesPageFragment4().apply {
